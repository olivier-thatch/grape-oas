...
- [#72](https://github.com/numbata/grape-oas/pull/72): Infer 201 for POST success responses and honor entity response `default_status:` for all methods - [@olivier-thatch](https://github.com/olivier-thatch).
