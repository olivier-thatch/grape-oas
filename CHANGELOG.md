...
- [#72](https://github.com/numbata/grape-oas/pull/72): Infer POST success status only when no success is declared; honor entity `default_status:` for all methods, omitting content for bodyless statuses - [@olivier-thatch](https://github.com/olivier-thatch).
