...
- [#1](https://github.com/olivier-thatch/grape-oas/pull/1): Add `grape_swagger_backwards_compat` option to emit camelCase operation ids and drop the `_Request` request body schema suffix, matching grape-swagger naming - [@olivier-thatch](https://github.com/olivier-thatch).
