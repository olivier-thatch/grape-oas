...
- [#104](https://github.com/numbata/grape-oas/pull/104): Preserve array-valued schema examples and Boolean false examples from parameter/entity documentation in OAS 3.0/3.1; omit incompatible scalar examples while preserving decimal interpretation of integer strings - [@olivier-thatch](https://github.com/olivier-thatch).
