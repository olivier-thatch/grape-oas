...
- [#104](https://github.com/numbata/grape-oas/pull/104): Preserve array-valued schema examples in OAS 3.0/3.1 instead of truncating them to the first element - [@olivier-thatch](https://github.com/olivier-thatch).
